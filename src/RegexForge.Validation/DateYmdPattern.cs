...
/// <summary>
/// Provides validation, matching, and string operations for dates in yyyy-MM-dd format.
/// </summary>
public static partial class DateYmdPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.DateYmd, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.DateYmd,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.DateYmd;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(DateYmdPattern))
        {
        }
    }
}
