...
/// <summary>
/// Provides validation, matching, and string operations for MD5 hashes.
/// </summary>
public static partial class Md5Pattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Md5, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Md5;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(Md5Pattern))
        {
        }
    }
}
