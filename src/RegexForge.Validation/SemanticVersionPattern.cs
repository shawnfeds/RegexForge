...
/// <summary>
/// Provides validation, matching, and string operations for semantic version
/// strings per the SemVer 2.0.0 specification.
/// </summary>
/// <example>
/// <code>
/// bool isValid = SemanticVersionPattern.IsValid("1.2.3-rc.1+build.5");
/// </code>
/// </example>
public static partial class SemanticVersionPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.SemanticVersion, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.SemanticVersion,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.SemanticVersion;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(SemanticVersionPattern))
        {
        }
    }
}
