...
/// <summary>
/// Provides validation, matching, and string operations for SWIFT/BIC bank identifier codes.
/// </summary>
public static partial class SwiftPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Swift, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Swift;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(SwiftPattern))
        {
        }
    }
}
