...
/// <summary>
/// Provides validation, matching, and string operations for currency amounts with thousands separators.
/// </summary>
public static partial class CurrencyPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Currency, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Currency,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Currency;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(CurrencyPattern))
        {
        }
    }
}
