...
/// <summary>
/// Provides validation, matching, and string operations for single HTML tags (shallow structural match).
/// </summary>
public static partial class HtmlTagPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.HtmlTag, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.HtmlTag,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.HtmlTag;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(HtmlTagPattern))
        {
        }
    }
}
