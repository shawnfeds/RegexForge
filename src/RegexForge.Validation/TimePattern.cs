...
/// <summary>
/// Provides validation, matching, and string operations for 24-hour times in HH:mm or HH:mm:ss format.
/// </summary>
public static partial class TimePattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Time, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Time;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(TimePattern))
        {
        }
    }
}
