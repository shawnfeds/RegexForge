...
/// <summary>
/// Provides validation, matching, and string operations for RFC 3339 date-time strings.
/// </summary>
public static partial class Rfc3339Pattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Rfc3339, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Rfc3339,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Rfc3339;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(Rfc3339Pattern))
        {
        }
    }
}
