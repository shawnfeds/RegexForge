...
/// <summary>
/// Provides validation, matching, and string operations for United States ZIP codes.
/// </summary>
public static partial class UsZipCodePattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.UsZipCode, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.UsZipCode,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.UsZipCode;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(UsZipCodePattern))
        {
        }
    }
}
