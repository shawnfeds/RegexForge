...
/// <summary>
/// Provides validation, matching, and string operations for Indian PAN tax identifiers.
/// </summary>
public static partial class IndiaPanPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.IndiaPan, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.IndiaPan,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.IndiaPan;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(IndiaPanPattern))
        {
        }
    }
}
