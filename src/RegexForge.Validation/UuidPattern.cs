...
/// <summary>
/// Provides validation, matching, and string operations for UUIDs (alias of GuidPattern).
/// </summary>
public static partial class UuidPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Uuid, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Uuid;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(UuidPattern))
        {
        }
    }
}
