...
/// <summary>
/// Provides validation, matching, and string operations for Base64-encoded strings.
/// </summary>
public static partial class Base64Pattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Base64, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Base64,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Base64;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(Base64Pattern))
        {
        }
    }
}
