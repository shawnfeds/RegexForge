...
/// <summary>
/// Provides validation, matching, and string operations for numbers in scientific notation.
/// </summary>
public static partial class ScientificNotationPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.ScientificNotation, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.ScientificNotation,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.ScientificNotation;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(ScientificNotationPattern))
        {
        }
    }
}
