...
/// <summary>
/// Provides validation, matching, and string operations for IPv4 addresses in dotted-quad notation.
/// </summary>
public static partial class Ipv4Pattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Ipv4, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Ipv4;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(Ipv4Pattern))
        {
        }
    }
}
