...
/// <summary>
/// Provides validation, matching, and string operations for MAC addresses.
/// </summary>
public static partial class MacAddressPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.MacAddress, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.MacAddress,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.MacAddress;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(MacAddressPattern))
        {
        }
    }
}
