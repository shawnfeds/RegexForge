...
/// <summary>
/// Provides validation, matching, and string operations for United States phone numbers.
/// </summary>
public static partial class UsPhoneNumberPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.UsPhoneNumber, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.UsPhoneNumber,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.UsPhoneNumber;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(UsPhoneNumberPattern))
        {
        }
    }
}
