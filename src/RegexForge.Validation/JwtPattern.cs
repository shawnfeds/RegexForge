...
/// <summary>
/// Provides validation, matching, and string operations for the structural shape
/// of a JSON Web Token (three base64url segments separated by periods).
/// </summary>
/// <remarks>
/// This validates structure only, not signature or claims.
/// </remarks>
/// <example>
/// <code>
/// bool isValid = JwtPattern.IsValid(jwt);
/// </code>
/// </example>
public static partial class JwtPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Jwt, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Jwt;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(JwtPattern))
        {
        }
    }
}
