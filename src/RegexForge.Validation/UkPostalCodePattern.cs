...
/// <summary>
/// Provides validation, matching, and string operations for United Kingdom postcodes.
/// </summary>
public static partial class UkPostalCodePattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.UkPostalCode, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.UkPostalCode,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.UkPostalCode;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(UkPostalCodePattern))
        {
        }
    }
}
