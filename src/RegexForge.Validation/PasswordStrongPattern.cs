...
/// <summary>
/// Provides validation, matching, and string operations for "strong" passwords:
/// minimum 8 characters with at least one uppercase letter, one lowercase letter,
/// one digit, and one special character.
/// </summary>
/// <example>
/// <code>
/// bool isValid = PasswordStrongPattern.IsValid("Str0ng!Pass");
/// </code>
/// </example>
public static partial class PasswordStrongPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.PasswordStrong, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.PasswordStrong,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.PasswordStrong;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(PasswordStrongPattern))
        {
        }
    }
}
