...
/// <summary>
/// Provides validation, matching, and string operations for UTC offset timezone designators.
/// </summary>
public static partial class TimeZonePattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.TimeZone, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.TimeZone,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.TimeZone;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(TimeZonePattern))
        {
        }
    }
}
