...
/// <summary>
/// Provides validation, matching, and string operations for display names.
/// </summary>
public static partial class DisplayNamePattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.DisplayName, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.DisplayName,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.DisplayName;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(DisplayNamePattern))
        {
        }
    }
}
