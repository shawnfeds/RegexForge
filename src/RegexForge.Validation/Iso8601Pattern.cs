...
/// <summary>
/// Provides validation, matching, and string operations for ISO 8601 date or date-time strings.
/// </summary>
public static partial class Iso8601Pattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Iso8601, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Iso8601,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Iso8601;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(Iso8601Pattern))
        {
        }
    }
}
