...
/// <summary>
/// Provides validation, matching, and string operations for signed or unsigned integers.
/// </summary>
public static partial class IntegerPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Integer, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Integer,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Integer;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(IntegerPattern))
        {
        }
    }
}
