...
/// <summary>
/// Provides validation, matching, and string operations for IPv6 addresses, full or compressed form.
/// </summary>
public static partial class Ipv6Pattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Ipv6, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Ipv6;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(Ipv6Pattern))
        {
        }
    }
}
