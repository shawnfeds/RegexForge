...
/// <summary>
/// Provides validation, matching, and string operations for SHA-256 hashes.
/// </summary>
public static partial class Sha256Pattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Sha256, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Sha256,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Sha256;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(Sha256Pattern))
        {
        }
    }
}
