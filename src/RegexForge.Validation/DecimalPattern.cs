...
/// <summary>
/// Provides validation, matching, and string operations for signed or unsigned decimal numbers.
/// </summary>
public static partial class DecimalPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Decimal, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Decimal,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Decimal;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(DecimalPattern))
        {
        }
    }
}
