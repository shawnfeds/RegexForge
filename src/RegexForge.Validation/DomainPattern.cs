...
/// <summary>
/// Provides validation, matching, and string operations for domain names.
/// </summary>
public static partial class DomainPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Domain, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.Domain,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Domain;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(DomainPattern))
        {
        }
    }
}
