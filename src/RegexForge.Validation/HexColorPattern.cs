...
/// <summary>
/// Provides validation, matching, and string operations for hexadecimal color codes,
/// with or without a leading '#', in 3, 4, 6, or 8 digit form.
/// </summary>
/// <example>
/// <code>
/// bool isValid = HexColorPattern.IsValid("#FF5733");
/// </code>
/// </example>
public static partial class HexColorPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.HexColor, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.HexColor,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.HexColor;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(HexColorPattern))
        {
        }
    }
}
