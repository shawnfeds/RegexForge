...
/// <summary>
/// Provides validation, matching, and string operations for RFC 1123 hostnames.
/// </summary>
public static partial class HostPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.Host, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.Host;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(HostPattern))
        {
        }
    }
}
