...
/// <summary>
/// Provides validation, matching, and string operations for Indian PIN codes.
/// </summary>
public static partial class IndiaPostalCodePattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.IndiaPostalCode, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.IndiaPostalCode,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.IndiaPostalCode;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(IndiaPostalCodePattern))
        {
        }
    }
}
