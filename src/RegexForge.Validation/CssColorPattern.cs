...
/// <summary>
/// Provides validation, matching, and string operations for CSS color values (hex, rgb, rgba).
/// </summary>
public static partial class CssColorPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.CssColor, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.CssColor,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.CssColor;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(CssColorPattern))
        {
        }
    }
}
