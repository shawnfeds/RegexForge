...
/// <summary>
/// Provides validation, matching, and string operations for the general structural shape of API keys.
/// </summary>
public static partial class ApiKeyPattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.ApiKey, RegexOptions.CultureInvariant)]
    private static partial Regex CreateRegex();

    private static readonly Regex _regex = CreateRegex();
#else
    private static readonly Regex _regex = new Regex(
        RegexPatterns.ApiKey,
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.ApiKey;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(ApiKeyPattern))
        {
        }
    }
}
