...
/// <summary>
/// Provides validation, matching, and string operations for full names (two or more space-separated parts).
/// </summary>
public static partial class FullNamePattern
{
#if NET7_0_OR_GREATER
    [GeneratedRegex(RegexPatterns.FullName, RegexOptions.CultureInvariant)]
    ...
    /// </summary>
    public static string Pattern => RegexPatterns.FullName;
    ...
    {
        public Validator(Regex regex) : base(regex, nameof(FullNamePattern))
        {
        }
    }
}
